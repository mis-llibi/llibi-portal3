...
<html>
<head>
    <title>Archive Cron Job Success - Requests Data</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
        <h2 style="color: #28a745;">Cron Job Execution Successful</h2>
        <p>The automated archiving process for <strong>app_portal_requests</strong> has completed successfully.</p>
