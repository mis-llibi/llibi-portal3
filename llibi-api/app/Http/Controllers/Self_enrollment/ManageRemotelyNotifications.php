...
class ManageremotelyNotifications extends Controller
{
    ...
    public function rolloverInvite($info)
    {
        ...
        We will ask you to confirm information about yourself and your dependents. Please complete this so that you and/or your dependents may be enrolled in Remotely’s renewal. You are encouraged to complete this from ' . $startDate . ' to ' . $dateFinalWarning . ' to avoid any coverage issues.<br /><br />
        
        If you do not respond to this notification by ' . $dateFinalWarning . ', you and your existing dependents will be automatically enrolled in Remotely’s healthcare plan renewal.<br /><br />
    ...
    public function rolloverWarningUntouchedForm($info, $dateFinalWarning, $dateFormLocked)
    {
        ...
        If you do not respond to this notification by ' . date('F j', strtotime($dateFinalWarning)) . ', you and your existing dependents will be automatically enrolled in Remotely’s healthcare plan renewal.<br /><br />
    ...
    public function invite($info)
    {
        ...
        $body =
            'Good day!
        Thank you for your interest in signing up for Remote Philippines Inc.’s healthcare plan. In order to confirm (or decline) your enrollment as well as that of your dependents, please visit this link ' . $link . ' and accomplish this form online.<br /><br />
        
        We will ask you to confirm information about yourself and your dependents. Please complete this so that you and/or your dependents may be covered as soon as possible. You are encouraged to complete this within the next 12 days in order to avoid any coverage issues.<br /><br />
    ...
    public function approvedWithCertificateNo($info)
    {
        ...
        $attachment = [
            //'public/Self_enrollment/remotely/001Welcome_pack/remotely - WELCOME LETTER 2024.pdf',
            //'public/Self_enrollment/remotely/001Welcome_pack/remotely NTP.pdf',
            'public/Self_enrollment/remotely/001Welcome_pack/SOC_SME LUXE - Remotely.pdf',
        ];
