...
use App\Http\Controllers\Self_enrollment\ManageEigthByEigthEnrollee;
...
class EigthByEigthExportEnrollee implements FromArray, WithHeadings, ShouldAutoSize, WithEvents, WithStyles
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) use ($count) {
                ...
                $event->sheet->getStyle('A1:M'.$count)->applyFromArray([
                    'borders' => [
                        'allBorders' => [
