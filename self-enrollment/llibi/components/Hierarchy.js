    ...
    if (civilStatus == 'SINGLE') {
        return (
            <>
                <div>
                    <p>
                        Dependents you may enroll in this healthcare program are
                        determined by your <b>civil status</b>
                    </p>
                    <p>
                ...
                <div className="flex mt-2">
                    ...
                    <div className="px-4 flex place-items-center">
                        <img
                            src={`${basePath}/self-enrollment/single.png`}
                            width={40}
                        />
                    </div>
                    <table>
                ...
                <div className="mt-2">
                    <p>
                        Skipping of the hierarchy is only permitted for the
                        reasons below. Please select the appropriate reason in
                        the given fields. Otherwise, leave this field blank.
                    </p>
                    <br />
                    <ul className="list-disc">
                        <li>Death, or your dependent is deceased.</li>
                        <li>
                            Other Coverage, or your dependent is already covered
                            by another HMO or Insurance Company.
                        </li>
                        <li>
                            Working Abroad, or your dependent is employed
        ...
        return (
            <>
                ...
                <div className="flex mt-2">
                    ...
                    <div className="px-4 flex place-items-center">
                        <img
                            src={`${basePath}/self-enrollment/married.png`}
                            width={40}
                        />
                    </div>
                    <table>
