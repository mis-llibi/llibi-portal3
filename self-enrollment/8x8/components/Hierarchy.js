...
const hierarchy = ({ civilStatus }) => {
    if (civilStatus == 'SINGLE') {
        return (
            <>
                <div>
                    ...
                    <p>
                        Your dependents must also meet the age eligibility
                        criteria below
                    </p>
                </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td className="font-bold">Civil Status</td>
                                <td className="pl-2">
                                    Single With Domestic Partner / Same Gender
                                    Partner
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className="pl-2">
                                    Domestic Partner / Same Gender Partner
                                </td>
                            </tr>
                            <tr>
                                <td className="font-bold">Age Eligibility</td>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="pl-2">
                                    Children, Parents, Domestic Partner / Same
                                    Gender Partner
                                </td>
                            </tr>
                            <tr>
        ...
        return (
            <p className="font-bold text-red-400">No Civil Status Selected</p>
        )
    }
}
