...
const ModalUpdateEnrolleeBroadPath = ({
    data,
    company,
    update,
    loading,
                    ...
                    <table className="table-auto w-full bg-white">
                        <thead>
                            <tr>
                                ...
                                <th className="border">BirthDate</th>
...
export default ModalUpdateEnrolleeBroadPath
