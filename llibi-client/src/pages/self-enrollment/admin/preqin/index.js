...
import ModalUploadCertificateNumber from './components/modalUploadCertificateNumber'
...
const HomePreqin = ({ register, watch, props }) => {
  const [watchSelection, setWatchSelection] = useState(1)
  const {
    clients,
    importClients,
  ...
  const modUploadCertificateNumber = () => {
    props?.setBody({
      title: 'Upload Excel File to Masterlist',
      content: (
        <ModalUploadCertificateNumber
          upload={importClientsForApproving}
          loading={props?.loading}
          setLoading={props?.setLoading}
          setShow={props?.setShow}
        />
      ...
      <div className="max-w-xl mx-auto sm:px-6 lg:px-8 mt-2">
        <Select
          ...
          options={[
            ...
            { label: 'Submitted Enrollment', value: 3 },
            // { label: 'Approved Members', value: 5 },
            // { label: 'Cancelled Members', value: 6 },
          ]}
          onChange={e => setWatchSelection(e.target.value)}
      ...
      <div className="py-2">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div className={`px-3 pt-3 ${watchSelection == 1 || 'hidden'}`}>
              <Button
            ...
            {/* <div className={`px-3 pt-3 ${watchSelection == 2 || 'hidden'}`}>
              <ButtonLink
              ...
              <ButtonLink
                onClick={modUploadCertificateNumber}
                className="mr-2 bg-orange-400 hover:bg-orange-600 focus:bg-orange-600 active:bg-orange-700 ring-orange-200 mb-2 md:mb-0 w-full md:w-auto"
                disabled={props?.loading}>
                Upload Certificate #
              </ButtonLink>
            ...
            {/* APPROVED BOX */}
            {/* <div className={`px-3 pt-3 ${watchSelection || 'hidden'}`}>
              <ButtonLink
                onClick={onExportEnrollee}
                className="mr-2 bg-green-400 hover:bg-green-600 focus:bg-green-600 active:bg-green-700 ring-green-200 mb-2 md:mb-0 w-full md:w-auto"
                disabled={props?.loading}>
