          ...
          <div className="border border-y-2 p-2 mb-2">
            <div className="md:flex gap-6 mb-3 border-b-2 border-dotted pb-0 md:pb-3">
              ...
              <div className="mb-4 md:mb-0 md:flex-grow mx-auto w-full md:w-4/6 items-center justify-center text-md text-justify text-orange-900 text-xs italic font-semibold">
                Please list down below all your eligible dependents as indicated
                above following the hierarchy. Include any dependents that you
                do not intend to enroll. For dependents you do not intend to
                enroll: Tick the box marked “Skip Hierarchy”, indicate the
                reason you are not enrolling the dependent, and upload the
                supporting documentary proof so that the specified dependent is
                not enrolled.
              </div>
            </div>
