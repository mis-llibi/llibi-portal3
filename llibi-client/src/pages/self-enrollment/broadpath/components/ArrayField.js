            ...
            <div className="lg:flex">
                ...
                <div className="flex-grow mt-2 lg:mt-0 flex place-items-center justify-end hidden">
                    <p
                        ...
                        Your annual premium is ₱ xxx with monthly premium of ₱
                        xxx. Premium refund is not allowed if membership is
                        terminated/ deleted mid policy year.
                    </p>
                </div>
            </div>
        </>
