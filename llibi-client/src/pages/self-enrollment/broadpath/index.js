          ...
          <div className="basis-1/2 lg:border-r-4 pb-2 lg:pb-0 lg:pr-2">
            ...
            <div className="mt-3">
              <p className="text-center text-sm font-semibold">
                To facilitate enrollment for yourself and your dependents,
            ...
            <div className="mt-3 p-4 rounded-md bg-orange-50">
              <h1 className="mb-2 text-blue-600 font-bold">Important Notice</h1>
              <p className="text-sm text-justify">
                Please review and make the necessary corrections (if any) to
                your{' '}
                <span className="text-blue-400 font-bold">
                  personal information
                </span>{' '}
                before submitting as these will be used for your Healthcare
                enrollment. Once submitted, data provided becomes final.
              </p>
            </div>
