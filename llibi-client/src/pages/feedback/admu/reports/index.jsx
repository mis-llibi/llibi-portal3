      ...
      <div className="bg-[#f1faee] font-[poppins]">
        ...
        <div className="px-10 md:px-20 text-gray-800">
          ...
          <div className="flex justify-end mb-3">
            <a
              href={`${process.env.backEndUrl}/api/admu/feedbacks-export`}
              target="_blank">
                  ...
                  feedbacks?.result?.data.map(feedback => {
                    return (
                      <tr key={feedback.id} className="border even:bg-gray-100">
                        <td className="p-5 font-bold text-xs whitespace-nowrap lg:whitespace-normal">
          ...
          <div className="flex justify-end">
            <div>
              <button
                className={`w-24 border bg-blue-900 p-2 uppercase text-xs rounded-md text-white mb-3 ${
