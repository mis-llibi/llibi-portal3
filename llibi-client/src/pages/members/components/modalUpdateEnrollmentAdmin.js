      ...
      <form onSubmit={handleSubmit(submitForm)}>
        ...
        <div
          ...
          <div className="mb-2 basis-4/6">
            <div className={`${watch('changeStatus') == 6 && 'hidden'}`}>
              <Label htmlFor="certificateNo">Card Number</Label>
              <Input
                id="certificateNo"
                type="text"
                className="block mt-1 w-full"
            ...
            <div className={`${watch('changeStatus') == 4 && 'hidden'}`}>
              <Label htmlFor="adminRemarks">Remarks</Label>
              <TextArea
                id="adminRemarks"
                register={register('adminRemarks', {
                  required:
                    watch('changeStatus') == 6 ? 'Remarks is required' : false,
                })}
                className={'mt-1 w-full'}
                errors={errors?.adminRemarks}
                disabled={watch('changeStatus') == 4}></TextArea>
            </div>
          </div>
        </div>
